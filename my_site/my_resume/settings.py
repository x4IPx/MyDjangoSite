...
#SECRET_KEY ='django-insecure-knp!rswtk&d^c_792a^)3e)fihtu@te4r97v98o!o#ot=k#oe)'
...
#ALLOWED_HOSTS = ['*']
CSRF_TRUSTED_ORIGINS = os.environ.get("DJANGO_CSRF_TRUSTED_ORIGINS").split(' ') # С 4.0 версии 
